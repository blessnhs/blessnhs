...
static void InitDefaultsscc_info_Person_Proto_2fsample_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Person_Proto_2fsample_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Person_Proto_2fsample_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_Proto_2fsample_2eproto[1];
...
const char descriptor_table_protodef_Proto_2fsample_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022Proto/sample.proto\022\010tutorial\"1\n\006Person"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_Proto_2fsample_2eproto_sccs[1] = {
  &scc_info_Person_Proto_2fsample_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_Proto_2fsample_2eproto_once;
static bool descriptor_table_Proto_2fsample_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Proto_2fsample_2eproto = {
  &descriptor_table_Proto_2fsample_2eproto_initialized, descriptor_table_protodef_Proto_2fsample_2eproto, "Proto/sample.proto", 89,
  &descriptor_table_Proto_2fsample_2eproto_once, descriptor_table_Proto_2fsample_2eproto_sccs, descriptor_table_Proto_2fsample_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_Proto_2fsample_2eproto::offsets,
  file_level_metadata_Proto_2fsample_2eproto, 1, file_level_enum_descriptors_Proto_2fsample_2eproto, file_level_service_descriptors_Proto_2fsample_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_Proto_2fsample_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_Proto_2fsample_2eproto), true);
namespace tutorial {
...
void Person::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Person_Proto_2fsample_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  email_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  id_ = 0;
}
