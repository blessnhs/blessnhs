...
namespace GSFrontServer	{	 namespace PlayerContainer	{
	...
	typedef GSFrontServer::Player::Player Player;
	typedef boost::shared_ptr<Player> PlayerPtr;

template<template<class T> class CreationPolicy>
class PlayerContainer : public IContainer<PlayerPtr>, public CreationPolicy<Player> , public IResponse
{
public:
	PlayerContainer();
	~PlayerContainer();
	...
	void DeleteAllBySession(GSCLIENT *pSession);
...
#define PLAYERMGR GSFrontServer::PlayerContainer::GetPlayerContainer()
