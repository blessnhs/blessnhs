...
#define 	INADDR_ANY   		0x00000000 // Any IP address.
#define 	INADDR_BROADCAST   	0xffffffff // Broadcast IP address.

#define		FD_SOCK		0x100
...
typedef struct {
          ...
          unsigned short sin6_addr[8];     /* IPv6 address             */
} sockaddr_in6;
