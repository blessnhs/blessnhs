...
#define ICMP_WHERE_ARE_YOU                 33       // Urspr�nglich IPv6 Where-Are-You (ersetzt durch ICMPv6)
#define ICMP_I_AM_HERE                     34       // Urspr�nglich IPv6 I-Am-Here (ersetzt durch ICMPv6)
